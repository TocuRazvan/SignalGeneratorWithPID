...
#define  PANEL_NUMERIC_ALPHA              19      /* control type: numeric, callback function: calculare_ti_td_kr_alpha */
#define  PANEL_NUMERIC_TD                 20      /* control type: numeric, callback function: calculare_ti_td_kr_alpha */
#define  PANEL_NUMERIC_TI                 21      /* control type: numeric, callback function: calculare_ti_td_kr_alpha */
#define  PANEL_NUMERIC_KR                 22      /* control type: numeric, callback function: calculare_ti_td_kr_alpha */
#define  PANEL_buton                      23      /* control type: textButton, callback function: Perturbatie */
#define  PANEL_buton_comp                 24      /* control type: textButton, callback function: compensator */
...
#define  PANEL_PERTURBATIE                28      /* control type: scale, callback function: Perturbatie */
...
int  CVICALLBACK compensator(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
...
int  CVICALLBACK Perturbatie(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
